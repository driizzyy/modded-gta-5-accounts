        ...
        if (product.status === "available") {
            buttonHTML = `
                <div class="product-actions">
                    <a href="discord://${DISCORD_BOT_ID}" class="btn-discord" onclick="handleDiscordPurchase(event, '${Object.keys(products).find(key => products[key] === product)}')">
                        💜 Purchase on Discord
                    </a>
                </div>
            `;
...
function handleDiscordPurchase(event, productKey) {
    ...
    if (DISCORD_SERVER_INVITE === "https://discord.gg/YOUR_INVITE_CODE" || 
    ...
    // Store the product key in sessionStorage for after OAuth
    sessionStorage.setItem('purchaseProduct', productKey);
